...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Hero */}
      <div className="bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 text-white px-4 sm:px-6 pt-12 pb-8 text-center relative overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto px-4 pt-7 pb-16 sm:pb-12">
        <div className="flex items-center justify-between mb-5">
          <h2 className="font-extrabold text-gray-900 text-base tracking-tight">Choose a Topic</h2>
          <button
            onClick={() => { if (window.confirm('Reset all progress? This cannot be undone.')) resetAll(); }}
            className="text-xs font-semibold text-red-400 hover:text-red-600 border border-red-200 hover:border-red-400 px-3 py-1.5 rounded-full transition-colors touch-manipulation"
          >
            Reset progress
          </button>
        </div>
